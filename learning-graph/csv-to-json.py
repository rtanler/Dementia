...
def csv_to_json(csv_path: str, json_path: str, color_config: dict = None, metadata: dict = None):
    ...
    taxonomy_names = {
        # Custom taxonomies for dementia guidebook
        'FOUND': 'Foundation Concepts',
        'NEURO': 'Neuroscience',
        'DTYPE': 'Dementia Types',
        'SYMPT': 'Symptoms & Stages',
        'DIAG': 'Diagnosis & Assessment',
        'TREAT': 'Treatment & Therapies',
        'PREV': 'Risk Factors & Prevention',
        'CARE': 'Daily Living & Caregiving',
        'COMM': 'Communication',
        'SAFE': 'Safety & Home Modifications',
        'LEGAL': 'Legal & Financial Planning',
        'SUPP': 'Support & Resources',
