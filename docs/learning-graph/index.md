# Learning Graph for Understanding Dementia
...
- Foundational concepts: 4 entry points (Brain, Cognition, Age-Related Risk, Body Language)
- Indegree distribution analysis
- Longest dependency chains (maximum 8 steps)
- Connectivity: All concepts connected in single graph
...
- 12 categories for dementia education
- Category organization - foundational elements first, support resources last
- Balanced categories (5.0% - 12.5% each)
- All categories under 30% threshold
- Clear 3-5 letter abbreviations for use in CSV file
- Categories: Foundation, Neuroscience, Dementia Types, Symptoms & Stages, Diagnosis, Treatment, Prevention, Daily Care, Communication, Safety, Legal/Financial, Support & Resources
...
- Statistical breakdown: 12 categories, 200 concepts
- Detailed concept listing by category
- Visual distribution table
- Balance verification: Excellent (spread only 7.5%)
