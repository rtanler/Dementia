...
1. **Input** - Receiving information through your senses
2. **Encoding** - Converting sensory information into a form the brain can use
3. **Storage** - Keeping information available for later use
4. **Retrieval** - Accessing stored information when needed
5. **Output** - Responding based on processed information
