...
<iframe src="main.html" width="100%" height="1350" style="border:1px solid #e2e8f0; border-radius:8px;"></iframe>

[Run MicroSim in Fullscreen](main.html){ .md-button .md-button--primary }

## How to Use

1. **Pick a dementia type** from the selector at the top (Alzheimer's, Vascular, Lewy Body, or Frontotemporal).
2. **Hover** over the chart to see the exact capability level for each domain at any year.
3. **Toggle capability lines** on and off with the checkboxes under the chart to isolate specific domains.
4. **Answer the quiz** at the bottom to check your understanding. A celebration plays when all four answers are correct.
