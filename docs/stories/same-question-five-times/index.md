---
title: The Same Question, Five Times - Patience Is a Skill
description: A graphic novel about a son who learns that patience with a parent's repeated questions is not a personality trait but a caregiving skill — and how a kitchen whiteboard changed everything.
image: /stories/same-question-five-times/cover.png
og:image: /stories/same-question-five-times/cover.png
twitter:image: /stories/same-question-five-times/cover.png
social:
   cards: false
---
...
Contemporary photorealistic illustration, warm cinematic tone, 16:9 wide-landscape format. A cozy suburban American kitchen in the late afternoon. On the left wall hangs a large **dry-erase whiteboard** in a wood frame, clearly marked in neat block letters: *"TODAY: Wednesday, Oct 14"* / *"APPOINTMENT: Dr. Chen, 2:30 PM"* / *"DAVID COMES AT 11"* / *"DINNER: chicken & rice"*. In the center of the frame, **David**, age 55, warm brown skin, short salt-and-pepper hair and beard, wearing a soft charcoal cardigan over a light blue shirt, stands with a friendly steady posture holding a red dry-erase marker up, as if having just written on the board. To his right, sitting at the kitchen table with a cup of coffee, **Walter**, age 78, his father — medium-brown skin, close-cut silver hair, wearing a brown flannel shirt and reading glasses, looking up at the board with a peaceful, slightly amused expression. On the table: a coffee mug, a folded newspaper, reading glasses, a plate with a partially eaten slice of toast. Warm kitchen light from overhead pendant fixtures. Color palette: warm browns, soft cream walls, a pop of red from the marker, deep blue shirt, golden kitchen light. Emotional tone: calm, loving, competence after hard-won patience.

Title text overlay centered at top in clean modern sans-serif: "THE SAME QUESTION, FIVE TIMES" in warm white. Subtitle in smaller italic: "Patience is a skill, not a personality trait"
