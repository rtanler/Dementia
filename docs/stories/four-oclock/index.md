---
title: Four O'Clock - A Family's Journey Through Sundowning
description: A graphic novel of how one family learned to recognize and respond to sundowning, a common afternoon pattern in dementia care.
image: /stories/four-oclock/cover.png
og:image: /stories/four-oclock/cover.png
twitter:image: /stories/four-oclock/cover.png
social:
   cards: false
---
...
**Title treatment (top ~15% of frame):** Across the top of the image, centered horizontally, render the main title "FOUR O'CLOCK" in a warm ivory/cream humanist serif — the kind of hand-set lettering you would see on a classic illustrated-novel cover — with a soft painterly drop-shadow so the text integrates into the scene below, never a hard graphic bar. Directly beneath the title, in a smaller italic of the same serif, render the subtitle "A Family's Journey Through Sundowning". The lettering should feel as if the painter lettered it themselves, in the same brush vocabulary as the painting.

**Scene:** A suburban American living room bathed in golden late-afternoon light at 4:00 PM. On a cream-colored sofa, two Indian-American women sit together. On the left, Priya Sharma, 39, medium-brown skin, long dark hair in a loose low ponytail, tortoise-shell glasses, soft gray cardigan over a coral T-shirt, leans slightly toward her mother-in-law with a gentle tired smile, holding a ceramic teacup with both hands. On the right, Anita Sharma, 82, silver hair in a neat bun, warm brown skin, a soft lavender kurta with light embroidery at the collar, a maroon shawl over her shoulders, holds her own teacup with a small smile. Between them on a low wooden coffee table: a small teapot, a dish of almonds, a folded quilt, and a family photo in a wooden frame. A warm table lamp glows in the corner. The wall above them holds three framed photos — a wedding, grandchildren, and an older black-and-white photo of a young couple. A small potted tulsi plant sits on the windowsill.

**Emotional tone:** earned peace, tender love, the calm that comes after a hard-learned lesson.
