---
title: Three Forgotten Keys - A Daughter Notices the Pattern
description: A graphic novel about a daughter who moves from laughing off her mother's forgetfulness to recognizing the early warning signs of dementia and having the first honest conversation.
image: /stories/three-forgotten-keys/cover.png
og:image: /stories/three-forgotten-keys/cover.png
twitter:image: /stories/three-forgotten-keys/cover.png
social:
   cards: false
---
...
**Title treatment (top ~15% of frame):** Across the top of the image, centered horizontally, render the main title "THREE FORGOTTEN KEYS" in a warm ivory/cream humanist serif — the kind of hand-set lettering you would see on a classic illustrated-novel cover — with a soft painterly drop-shadow so the text integrates into the scene below, never a hard graphic bar. Directly beneath the title, in a smaller italic of the same serif, render the subtitle "A Daughter Notices the Pattern". The lettering should feel as if the painter lettered it themselves, in the same brush vocabulary as the painting.

**Scene:** A close-up composition of a suburban kitchen refrigerator, door open, cool interior light spilling out into a dim morning kitchen. On the middle shelf, among milk cartons and a bowl of leftovers, sits a small set of house keys on a red keychain — clearly out of place. In the soft background, out of focus: Maya, 42, medium-brown skin, shoulder-length curly dark hair, reading glasses pushed up on her head, navy work blazer, stands in the kitchen doorway with a concerned but gentle expression. A few feet behind her, Gloria, 71, warm olive skin, silver-gray hair in a short soft style, pale pink housecoat, looks slightly embarrassed and puzzled, one hand raised to her cheek. Morning light filters through a window behind them. On the refrigerator door: a family magnet, a child's crayon drawing, a calendar showing the current month. The cool fridge interior is rendered with warm painterly restraint rather than fluorescent cold.

**Emotional tone:** the quiet moment a daughter realizes something has shifted.
