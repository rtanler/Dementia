---
title: The Grab Bar We Should Have Put Up - A Home Safety Audit
description: A graphic novel about a daughter who learns, the hardest way, that a weekend home-safety audit can buy a parent years of safe living at home.
image: /stories/grab-bar/cover.png
og:image: /stories/grab-bar/cover.png
twitter:image: /stories/grab-bar/cover.png
social:
   cards: false
---
...
**Title treatment (top ~15% of frame):** Across the top of the image, centered horizontally, render the main title "THE GRAB BAR WE SHOULD HAVE PUT UP" in a warm ivory/cream humanist serif — the kind of hand-set lettering you would see on a classic illustrated-novel cover — with a soft painterly drop-shadow so the text integrates into the scene below, never a hard graphic bar. Directly beneath the title, in a smaller italic of the same serif, render the subtitle "A Home Safety Audit". The lettering should feel as if the painter lettered it themselves, in the same brush vocabulary as the painting.

**Scene:** A small suburban bathroom, warm and clean, with a newly installed stainless-steel grab bar mounted beside a white bathtub and a matching grab bar inside the shower. Morning light pours through a frosted window above the tub. A non-slip mat inside the tub; a fresh white towel on a hook. In the foreground at a safe distance, Sandra, 50, a white woman with shoulder-length ash-blonde hair, tortoise-shell glasses, a denim work shirt with sleeves rolled up and a small screwdriver in her hand, looks at the completed installation with quiet satisfaction and a faint shadow of regret. On the bathroom counter: a clipboard printed HOME SAFETY CHECKLIST with items checked off. Through the open bathroom door, in the hallway, Georgia, 79, slim older white woman with soft gray hair, pink house cardigan, soft brown slacks, moves slowly with a three-wheel walker back to her own life.

**Emotional tone:** learning late, but learning well.
