---
title: The Small Orange Pill - Hope You Can Live With
description: A graphic novel about a wife learning what dementia medications can and cannot do — and how to set honest expectations about the treatment of Alzheimer's disease.
image: /stories/small-orange-pill/cover.png
og:image: /stories/small-orange-pill/cover.png
twitter:image: /stories/small-orange-pill/cover.png
social:
   cards: false
---
...
Contemporary photorealistic illustration, warm cinematic tone, 16:9 wide-landscape format. An extreme close-up of a small round **orange pill** (about the size of an aspirin) resting in the center of an open palm. The palm belongs to **Elena**, age 52, a warm tan-skinned Latina woman with shoulder-length dark hair, a gentle worried expression, wearing a soft navy cardigan over a cream shell. Her hand is held steadily, fingers slightly curled. In the soft background out of focus: a sunlit kitchen counter, a glass of water, a pill organizer with days of the week labeled, and further back, **Mateo**, age 69, Elena's husband — warm tan skin, salt-and-pepper hair, kind eyes, wearing a soft olive long-sleeve shirt, sitting at the kitchen table reading a newspaper, blurred. Morning light streams in from a window. Color palette: warm morning golds, soft creams, the gentle orange pop of the pill, sage green accents. Emotional tone: tender hope that knows its limits.

Title text overlay centered at top in clean modern sans-serif: "THE SMALL ORANGE PILL" in warm white. Subtitle in smaller italic: "Hope you can live with"
